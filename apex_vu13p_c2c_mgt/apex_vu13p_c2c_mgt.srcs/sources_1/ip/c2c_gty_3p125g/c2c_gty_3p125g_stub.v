...
//               /home/madorsky/github/vivado/apex_ku15p/apex_vu13p_c2c_mgt/apex_vu13p_c2c_mgt.srcs/sources_1/ip/c2c_gty_3p125g/c2c_gty_3p125g_stub.v
...
module c2c_gty_3p125g(gtwiz_userclk_tx_reset_in, 
  ...
  drpclk_in, gtrefclk0_in, gtrxreset_in, gttxreset_in, gtyrxn_in, gtyrxp_in, rx8b10ben_in, 
  rxbufreset_in, rxcommadeten_in, rxmcommaalignen_in, rxpcommaalignen_in, rxpolarity_in, 
  rxprbssel_in, rxprogdivreset_in, rxuserrdy_in, rxusrclk_in, rxusrclk2_in, tx8b10ben_in, 
  txctrl0_in, txctrl1_in, txctrl2_in, txpolarity_in, txprbssel_in, txprogdivreset_in, 
  txuserrdy_in, txusrclk_in, txusrclk2_in, cplllock_out, gtpowergood_out, gtytxn_out, 
  gtytxp_out, rxbufstatus_out, rxbyteisaligned_out, rxbyterealign_out, rxcdrlock_out, 
  rxclkcorcnt_out, rxcommadet_out, rxctrl0_out, rxctrl1_out, rxctrl2_out, rxctrl3_out, 
  rxdata_out, rxoutclk_out, rxpmaresetdone_out, rxprbserr_out, rxresetdone_out, txoutclk_out, 
  txpmaresetdone_out, txresetdone_out)
/* synthesis syn_black_box black_box_pad_pin="gtwiz_userclk_tx_reset_in[0:0],gtwiz_userclk_tx_active_in[0:0],gtwiz_userclk_rx_active_in[0:0],gtwiz_reset_tx_done_in[0:0],gtwiz_reset_rx_done_in[0:0],gtwiz_userdata_tx_in[63:0],gtwiz_userdata_rx_out[63:0],cpllpd_in[1:0],drpclk_in[1:0],gtrefclk0_in[1:0],gtrxreset_in[1:0],gttxreset_in[1:0],gtyrxn_in[1:0],gtyrxp_in[1:0],rx8b10ben_in[1:0],rxbufreset_in[1:0],rxcommadeten_in[1:0],rxmcommaalignen_in[1:0],rxpcommaalignen_in[1:0],rxpolarity_in[1:0],rxprbssel_in[7:0],rxprogdivreset_in[1:0],rxuserrdy_in[1:0],rxusrclk_in[1:0],rxusrclk2_in[1:0],tx8b10ben_in[1:0],txctrl0_in[31:0],txctrl1_in[31:0],txctrl2_in[15:0],txpolarity_in[1:0],txprbssel_in[7:0],txprogdivreset_in[1:0],txuserrdy_in[1:0],txusrclk_in[1:0],txusrclk2_in[1:0],cplllock_out[1:0],gtpowergood_out[1:0],gtytxn_out[1:0],gtytxp_out[1:0],rxbufstatus_out[5:0],rxbyteisaligned_out[1:0],rxbyterealign_out[1:0],rxcdrlock_out[1:0],rxclkcorcnt_out[3:0],rxcommadet_out[1:0],rxctrl0_out[31:0],rxctrl1_out[31:0],rxctrl2_out[15:0],rxctrl3_out[15:0],rxdata_out[255:0],rxoutclk_out[1:0],rxpmaresetdone_out[1:0],rxprbserr_out[1:0],rxresetdone_out[1:0],txoutclk_out[1:0],txpmaresetdone_out[1:0],txresetdone_out[1:0]" */;
