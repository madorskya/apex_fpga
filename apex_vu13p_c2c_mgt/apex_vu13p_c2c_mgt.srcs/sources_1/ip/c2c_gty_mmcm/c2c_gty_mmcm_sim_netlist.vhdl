...
--               /mnt/slc6_disk/madorsky/projects/vivado/apex/vu13p/examples/c2c_gty_3p125g_ex/c2c_gty_3p125g_ex.srcs/sources_1/ip/c2c_gty_mmcm/c2c_gty_mmcm_sim_netlist.vhdl
-- Design      : c2c_gty_mmcm
...
entity c2c_gty_mmcm_c2c_gty_mmcm_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of c2c_gty_mmcm_c2c_gty_mmcm_clk_wiz : entity is "c2c_gty_mmcm_clk_wiz";
end c2c_gty_mmcm_c2c_gty_mmcm_clk_wiz;

architecture STRUCTURE of c2c_gty_mmcm_c2c_gty_mmcm_clk_wiz is
  signal clk_in1_c2c_gty_mmcm : STD_LOGIC;
  signal clk_out1_c2c_gty_mmcm : STD_LOGIC;
  signal clk_out2_c2c_gty_mmcm : STD_LOGIC;
...
entity c2c_gty_mmcm is
  ...
  attribute NotValidForBitStream of c2c_gty_mmcm : entity is true;
end c2c_gty_mmcm;

architecture STRUCTURE of c2c_gty_mmcm is
begin
inst: entity work.c2c_gty_mmcm_c2c_gty_mmcm_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
