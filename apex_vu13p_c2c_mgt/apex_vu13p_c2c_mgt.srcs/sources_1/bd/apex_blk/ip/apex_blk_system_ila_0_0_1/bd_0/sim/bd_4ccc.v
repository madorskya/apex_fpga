...
module bd_4ccc
   (SLOT_0_AXI_araddr,
    ...
    probe9,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_0_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN apex_blk_axi_c2c_phy_clk_0, DATA_WIDTH 32, FREQ_HZ 93750000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 0, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 6, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 16, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 16, NUM_WRITE_THREADS 1, PHASE 0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [31:0]SLOT_0_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_1_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_1_AXI, ADDR_WIDTH 16, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN apex_blk_axi_c2c_phy_clk_0, DATA_WIDTH 32, FREQ_HZ 93750000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 16, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 16, NUM_WRITE_THREADS 1, PHASE 0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [15:0]SLOT_1_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_2_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_2_AXI, ADDR_WIDTH 16, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN apex_blk_axi_c2c_phy_clk_0, DATA_WIDTH 32, FREQ_HZ 93750000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 16, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 16, NUM_WRITE_THREADS 1, PHASE 0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [15:0]SLOT_2_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXI:SLOT_2_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN apex_blk_axi_c2c_phy_clk_0, FREQ_HZ 93750000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0" *) input clk;
  input [0:0]probe0;
  input [63:0]probe1;
  input [63:0]probe2;
  input [0:0]probe3;
  ...
  bd_4ccc_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe12(net_slot_0_axi_arburst),
        ...
        .probe47(net_slot_1_axi_awsize),
        .probe48(net_slot_1_axi_b_cnt),
        .probe49(net_slot_1_axi_bresp),
        .probe5(probe5_1),
        .probe50(net_slot_1_axi_r_cnt),
        .probe51(net_slot_1_axi_rdata),
        .probe52(net_slot_1_axi_rresp),
        .probe53(net_slot_1_axi_wdata),
        ...
        .probe6(probe6_1),
        .probe60(net_slot_2_axi_ar_cnt),
        .probe61(net_slot_2_axi_araddr),
        .probe62(net_slot_2_axi_arburst),
        .probe63(net_slot_2_axi_arlen),
        .probe64(net_slot_2_axi_arprot),
        .probe65(net_slot_2_axi_arsize),
        .probe66(net_slot_2_axi_aw_cnt),
        .probe67(net_slot_2_axi_awaddr),
        .probe68(net_slot_2_axi_awburst),
        .probe69(net_slot_2_axi_awlen),
        .probe7(probe7_1),
        .probe70(net_slot_2_axi_awprot),
        .probe71(net_slot_2_axi_awsize),
        .probe72(net_slot_2_axi_b_cnt),
        .probe73(net_slot_2_axi_bresp),
        .probe74(net_slot_2_axi_r_cnt),
        .probe75(net_slot_2_axi_rdata),
        .probe76(net_slot_2_axi_rresp),
        .probe77(net_slot_2_axi_wdata),
        .probe78(net_slot_2_axi_wstrb),
        .probe79(net_slot_2_axi_aw_ctrl),
        .probe8(probe8_1),
        .probe80(net_slot_2_axi_w_ctrl),
        .probe81(net_slot_2_axi_b_ctrl),
        .probe82(net_slot_2_axi_ar_ctrl),
        .probe83(net_slot_2_axi_r_ctrl),
        .probe9(probe9_1));
