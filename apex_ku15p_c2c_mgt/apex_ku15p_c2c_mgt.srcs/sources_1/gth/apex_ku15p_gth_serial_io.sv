...
(
	...
	bufg_gt_tux TCDS_4_inst (.O(TCDS_4_mmcm_clk), .I(mgt_gth_tx_if[0][3].txoutclk));
	assign mgt_txusrclk[0][3] = TCDS_4_mmcm_clk; // tcds_tx0
    assign refclk5 = refclk [5];        // [3] corrected for c2c on Q230
    assign refclk5_bufg = refclk_b [5]; // [3] corrected for c2c on Q230
endmodule
