...
module bd_4ccc
  ...
  bd_4ccc_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe15(net_slot_0_axi_arburst),
        .probe16(net_slot_0_axi_arid),
        .probe17(net_slot_0_axi_arlen),
        .probe18(net_slot_0_axi_arsize),
        .probe19(net_slot_0_axi_aw_cnt),
        .probe2(probe2_1),
        .probe20(net_slot_0_axi_awaddr),
        .probe21(net_slot_0_axi_awburst),
        .probe22(net_slot_0_axi_awid),
        .probe23(net_slot_0_axi_awlen),
        ...
        .probe51(net_slot_1_axi_b_cnt),
        .probe52(net_slot_1_axi_bresp),
        .probe53(net_slot_1_axi_r_cnt),
        .probe54(net_slot_1_axi_rdata),
        .probe55(net_slot_1_axi_rresp),
        .probe56(net_slot_1_axi_wdata),
        .probe57(net_slot_1_axi_wstrb),
        ...
        .probe63(net_slot_2_axi_ar_cnt),
        .probe64(net_slot_2_axi_araddr),
        .probe65(net_slot_2_axi_arburst),
        .probe66(net_slot_2_axi_arlen),
        .probe67(net_slot_2_axi_arprot),
        .probe68(net_slot_2_axi_arsize),
        .probe69(net_slot_2_axi_aw_cnt),
        .probe7(probe7_1),
        .probe70(net_slot_2_axi_awaddr),
        .probe71(net_slot_2_axi_awburst),
        .probe72(net_slot_2_axi_awlen),
        .probe73(net_slot_2_axi_awprot),
        .probe74(net_slot_2_axi_awsize),
        .probe75(net_slot_2_axi_b_cnt),
        .probe76(net_slot_2_axi_bresp),
        .probe77(net_slot_2_axi_r_cnt),
        .probe78(net_slot_2_axi_rdata),
        .probe79(net_slot_2_axi_rresp),
        .probe8(probe8_1),
        .probe80(net_slot_2_axi_wdata),
        .probe81(net_slot_2_axi_wstrb),
        .probe82(net_slot_2_axi_aw_ctrl),
        .probe83(net_slot_2_axi_w_ctrl),
        .probe84(net_slot_2_axi_b_ctrl),
        .probe85(net_slot_2_axi_ar_ctrl),
        .probe86(net_slot_2_axi_r_ctrl),
        .probe9(probe9_1));
