...
module drp_bridge_tux #(
    parameter DRP_COUNT            = 2, 
    parameter DRP_ADDR_WIDTH       = 13,                
    parameter DRP_DATA_WIDTH       = 64,
    parameter S_AXI_ADDR_WIDTH     = 32,               
...
(
    ...
    (* X_INTERFACE_INFO = "xilinx.com:interface:drp:1.0 DRP0 DO" *)    input  [DRP_DATA_WIDTH-1:0] drp0_do,
    (* X_INTERFACE_INFO = "xilinx.com:interface:drp:1.0 DRP0 DI" *)    output [DRP_DATA_WIDTH-1:0] drp0_di,
    (* X_INTERFACE_INFO = "xilinx.com:interface:drp:1.0 DRP0 DADDR" *) output [DRP_ADDR_WIDTH-1:0] drp0_addr,
    ...
    (* X_INTERFACE_INFO = "xilinx.com:interface:drp:1.0 DRP1 DO" *)    input  [DRP_DATA_WIDTH-1:0] drp1_do,
    (* X_INTERFACE_INFO = "xilinx.com:interface:drp:1.0 DRP1 DI" *)    output [DRP_DATA_WIDTH-1:0] drp1_di,
    (* X_INTERFACE_INFO = "xilinx.com:interface:drp:1.0 DRP1 DADDR" *) output [DRP_ADDR_WIDTH-1:0] drp1_addr,
